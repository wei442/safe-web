	...
	<section>
		...
		<el-col style="padding-bottom: 0px;">
			<el-form ref="addForm" :model="addForm" :rules="addFormRules" label-width="120px">
				<el-form-item label="当前主管理员"><span style="color:#FF0000;">*</span> {{ addForm.userName }}</el-form-item> 
				<el-form-item label="手机号"><span style="color:#FF0000;">*</span> {{ addForm.userAccount }}</el-form-item>
				<el-form-item label="新主管理员" prop="newUserName">
				...
				this.$refs.addForm.validate((valid) => {
					if (valid) {
						...
						this.$confirm('确认保存吗？', '提示', {}).then(() => {
							alert('this.addForm.userAdminId===='+this.addForm.userAdminId);
							let params = { 
